...
import { ActivityCreateModal } from '../components/modals/ActivityCreateModal'
import { 
  Dialog, 
  DialogContent, 
  DialogDescription, 
...
function Activities() {
  ...
  const handleCreate = async () => {
    try {
      const data = { ...formData }
      if (data.deal_id === '' || data.deal_id === 'none') delete data.deal_id
  ...
  const handleDelete = async () => {
    try {
      await api.del(`/activities/${selectedActivity.id}`)
